...
from src.Convolution_NN import CNN_MODEL, train_cnn, test_cnn, CNNFeatureExtractor
...
def main():
    ...
    df = pd.DataFrame.from_dict(
        {"origial": train_loss_list, "alex": train_loss_list_alex, "feature_ex": train_loss_list_feat})
